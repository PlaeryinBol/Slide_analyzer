...
* You should structure the input text for the slide into semantic entities using this json-format:
{{
"title": Str,
...
* STRONGLY IMPORTANT: never translate input text - keep the original language (otherwise you will be penalized)!
------------------
### Input text ###
"{INPUT_TEXT}"
------------------
...
STRONGLY IMPORTANT: make sure that the you json is valid - carefully watch every key, quote, comma
