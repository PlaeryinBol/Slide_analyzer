...
### Instructions ###
* Looking at the attached slide you need to give me the top-{MAX_VALUE} most appropriate 3D objects
on a transparent background, which I can insert into this slide.
